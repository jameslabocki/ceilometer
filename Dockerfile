...
RUN yum install wget unzip git mongodb python-devel mysql-server libmysqlclient-devel libffi-devel libxml2-devel libxslt-devel python-setuptools python-pip libffi libffi-devel gcc gcc-devel python-pip -y
RUN pip install tox
RUN mkdir /opt/stack
